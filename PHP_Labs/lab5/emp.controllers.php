...
if(isset($_POST['login']))
{
    ...
    $result = $db->get_data("employees","username='{$_POST['username']}' and pass='{$_POST['password']}'");
...
// if($_FILES['emp_img']['size'] > 100000)
// {
//     $errors['img_size'] = "Image Size must be small";
// }
...
else
{
    ...
    $db->insert_data("employees","firstName,lastName,address,gendre,pass,username,country,img",
